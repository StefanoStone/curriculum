...
\newcommand{\placelastupdatedtext}{% \placetextbox{<horizontal pos>}{<vertical pos>}{<stuff>}
  \AddToShipoutPictureFG*{% Add <stuff> to current page foreground
    \put(
        ...
        \small\color{gray}\textit{Ultimo aggiornamento Maggio 2026}\hspace{\widthof{Ultimo aggiornamento Maggio 2026}}
    }}}%
  }%
}%
...
\begin{document}
    ...
    \begin{header}
        ...
        \AND%
        \kern 0.25 cm%
        \mbox{{\color{black}\footnotesize\faMapMarker*}\hspace*{0.13cm}Zurigo, Switzerland}%
        \kern 0.25 cm%
        % \AND%
        % \kern 0.25 cm%
    ...
    \section{Esperienza}
        ...
        \vspace{0.10 cm}
            ...
            \begin{highlights}
                ...
                \item Anti-abuso contro bots, spoofs, and tentativi di evasione dei meccanismi di sicurezza
            \end{highlights}
        \end{onecolentry}
        \vspace{0.2 cm}
    ...
    \section{Educazione}   
        ...
        \begin{onecolentry}
            \begin{highlights}
                \item \textbf{In materia di:} Network security, Software security, Computer forensics, Software analytics (\href{https://www3.unimol.it/dipartimenti/bioscienze-e-territorio/corso/sicurezza_sistemi_software_home}{SSS})
    ...
    \section{Progetti}
        ...
        2025}
            \textbf{Interfaccia Python per CLOC (\href{https://github.com/pycloc/pycloc}{pycloc})}
        \end{twocolentry}
